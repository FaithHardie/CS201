...
-   Box: IQR (inner-quartile range)

-   Whiskers: range from min to max (excl outliers.) +/- 1.5 sd
...
-   %\>% is also called dplyr pipe or Magrittr pipe. Pipe, pipe function, etc.
...
For color and clarity, is there more variation or covariation? Variation.
...
-   Is there a relationship between carat and cut?
    ...
    Weak negative relationship. The median ideal cut is lower carat than the median fair cut.
